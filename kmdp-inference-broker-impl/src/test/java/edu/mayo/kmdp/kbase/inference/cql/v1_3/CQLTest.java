...
public class CQLTest extends InferenceBaseTest {
  ...
  InferenceBroker initServer(KnowledgeAssetRepositoryApiInternal semRepo,
  ...
  public void testEngine() {
    ...
    MockSingletonAssetRepository semRepo =
        initMockRepo(id, InferenceBaseTest.VTAG, "/helloworld.cql");

    InferenceBroker server = initServer(semRepo, semRepo);

    Bindings out = server.evaluate(id, InferenceBaseTest.VTAG, new Bindings(), null)
  ...
  public void testEngineWithFHIR() {
    ...
    MockSingletonAssetRepository semRepo =
        initMockRepo(id, InferenceBaseTest.VTAG, "/testFHIR.cql");
    ...
    Bindings out =
        server.evaluate(id, InferenceBaseTest.VTAG, inputs, null).orElseGet(Bindings::new);
  ...
  public void testEngineWithPCO() {
    ...
    MockSingletonAssetRepository semRepo =
        initMockRepo(id, InferenceBaseTest.VTAG, "/testFHIRPCO.cql");
    ...
    Bindings out = server.evaluate(id, InferenceBaseTest.VTAG, inputs, null)
        .orElseGet(Bindings::new);
  ...
  public void testEngineWithAgeBuiltIn() {
    ...
    MockSingletonAssetRepository semRepo =
        initMockRepo(id, InferenceBaseTest.VTAG, "/testAge.cql");
  ...
  public void testTEEInference() {
    ...
    MockSingletonAssetRepository semRepo =
        initMockRepo(id, InferenceBaseTest.VTAG, "/testTEE.cql");
